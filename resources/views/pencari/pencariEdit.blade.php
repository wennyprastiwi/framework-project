...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('pencari.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<script>
    ...
    $(document).ready(function ()
    {
        ...
        setKota('{{ $pencari->lokasi->kota->id }}');
        ...
        setKecamatan('{{ $pencari->lokasi->kecamatan->id }}');
        ...
        setKelurahan('{{ $pencari->lokasi->kelurahan->id }}');

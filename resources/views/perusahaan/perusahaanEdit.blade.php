            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $perusahaan->nama_perusahaan }}" name="nama_perusahaan"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $perusahaan->lokasi->nama_lokasi }}" name="alamat_perusahaan"
                ...
                <div class="col-xs-3 col-sm-3 col-md-3">
                    ...
                    <select name="indonesia_provinces" class="form-control" id="provinsi">
                        ...
                        @php
                            $selected = "";
                                if ($prov->id == $perusahaan->lokasi->provinsi->id) {
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text"  value="{{ $perusahaan->alamat_web }}" name="alamat_web" class="form-control" placeholder="Masukkan Alamat Website"
                            required>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Email: </strong>
                        <input type="text" value="{{ $perusahaan->kontak->email }}" name="email" class="form-control"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $perusahaan->kontak->no_hp }}" name="no_hp" class="form-control"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="deskripsi_perusahaan" id="address" rows="5"
                            placeholder="Masukkan Deskripsi Perusahaan">{{ $perusahaan->deskripsi_perusahaan }}</textarea>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">

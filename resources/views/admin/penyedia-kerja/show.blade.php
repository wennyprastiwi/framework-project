            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <img class="img-responsive"
                        src="{{ asset('storage/logo_perusahaan/'.$penyediaKerja->logo_perusahaan) }}"
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-secondary">
                        <a class="text-white" download={{$penyediaKerja->dokumen->npwp}}
                            href="{{ Storage::url('public/npwp/'.$penyediaKerja->dokumen->npwp) }}">
                            Download NPWP
                        </a>
                    </button>
                    @else
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-secondary">
                        <a class="text-white" download={{$penyediaKerja->dokumen->sop}}
                            href="{{ Storage::url('public/sop/'.$penyediaKerja->dokumen->sop) }}">
                            Download SOP
                        </a>
                    </button>
                    @else
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-secondary">
                        <a class="text-white" download={{$penyediaKerja->dokumen->surat_domisili}}
                            href="{{ Storage::url('public/surat/'.$penyediaKerja->dokumen->surat_domisili) }}">
